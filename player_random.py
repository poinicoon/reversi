...
class PlayerRandom(player_base.PlayerBase):
    def execute_(self, raw_field: np.ndarray) -> np.ndarray:
        ...
        return put_coord_list[funcs.generate_random(0, len(put_coord_list))]

    def __init__(self, player_num: int, field_size: np.array, *, player_name="Random"):
